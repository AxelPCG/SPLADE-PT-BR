...
check "upload_to_hf.py" "python3 -m py_compile scripts/utils/upload_to_hf.py"
...
check "run_basic_evaluation.py" "python3 -m py_compile scripts/evaluation/run_basic_evaluation.py"

echo ""
echo "Script help:"
check "train --help" "python3 scripts/training/train_splade_pt.py --help"
check "eval --help" "python3 scripts/evaluation/run_basic_evaluation.py --help"
...
check "docs/EVALUATION_PLAN.md" "[ -f docs/EVALUATION_PLAN.md ]"
